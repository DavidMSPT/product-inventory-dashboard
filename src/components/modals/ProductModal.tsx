      ...
      <div className="rounded-2xl border border-border bg-surface p-5 shadow-xl">
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
          ...
          <div className="sm:col-span-1">
            <div className="rounded-xl border border-border bg-bg-muted p-2 text-center text-xs text-text-muted">
              ...
              {imageUrl && previewOk ? (
                ...
                <div className="mx-auto aspect-[4/3] w-full rounded bg-bg-muted p-4 text-text-muted">
